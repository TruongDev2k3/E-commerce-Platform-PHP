...
<body>
    <section class="main">
        <div class="list-menu" style="width: 1200px; height:45px; border:solid 1px;">
            ...
            <a href="http://127.0.0.1:8000/BillSuccess" class="title" style="padding-top:5px;text-decoration: none;width: 239px; height:45px;font-size: 20px; color:red; float:left;text-align:center;border-right: 1px solid;">Đơn đã đặt &nbsp;<i class="fa fa-check"></i></a>
        ...
        <div class="row">
            <div class="colf-9 colf-s-12 padding-table" style="padding-left: 0px; width:1300px;">
                ...
                <h2 style="margin-left: 10px; margin-bottom:10px;margin-top:10px;text-align:left;text-align:left;">Bill ID: {{ $invoice->MaHoaDon }}</h2>
