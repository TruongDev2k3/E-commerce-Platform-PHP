...
<body>
    <section class="main">
        <div class="list-menu" style="width: 1200px; height:45px; border:solid 1px;">
            ...
            <a href="http://127.0.0.1:8000/Pending" class="title" style="padding-top:5px;text-decoration: none;width: 239px; height:45px;font-size: 20px; color:red; float:left;text-align:center;border-right: 1px solid;">Chờ xử lý &nbsp;<i class="fa fa-spinner fa-spin"></i></a>
        ...
        <div class="row">
            <div class="colf-9 colf-s-12 padding-table" style="padding-left: 0px; width:1300px;">
                ...
                @endphp
                <button style="cursor: pointer;float:left; @if($invoice->TrangThai == 'Yêu cầu hủy') margin-left: 1080px;@else margin-left: 970px;@endif color:#fff; background-color:orange; border: none; line-height: 35px; font-weight: bold; padding: 3px 10px; font-size: 14px; margin-top: 10px; border-radius:3px;">
                    <span style="color: #fff; font-size:15px;">
                        {{ $invoice->TrangThai }} <i class="fa fa-spinner fa-spin"></i>
                    </span>
                </button>
