...
<head>
    ...
    <title>Đăng nhập tài khoản | Mua Bán Trên Ứng Dụng Điện thoại hoặc Website</title>
...
<body>
    <div class="header_login">
        <div href="./Shopee.html" class="header__logos">
            <img src="/Images/Image/anhlogosp.png" alt="">
    ...
    <div class="content_login">
        <div class="img_shopee">
            <img src="/Images/Image/anhlogoshopee.png" alt="">
        </div>
        <form action="{{ route('login') }}" method="POST" class="form_login" id="form_login" autocomplete="on">
            @csrf
            <div class="title_form_login">
                Đăng nhập
            </div>
            <div class="qrcode">
                <img src="/Images/Image/anhqrlogin.png" alt="">
            </div>
            <div class="form-group">
                <!-- <label for="username">Email/Số điện thoại/Tên đăng nhập</label> -->
                <input id="username" name="username" type="text" placeholder="Email/Số điện thoại/Tên đăng nhập" class="form-control"><br>
                <span class="form-message"></span>
            </div>
            <div class="form-group">
                <!-- <label for="password">Mật khẩu</label> -->
                <input id="password" name="password" type="password" placeholder="Mật khẩu" class="form-control">
                <div class="btn_eye"><svg fill="none" class="_340FWs">
                ...
                <div class="btn_eyes"><img src="/Images/Image/eye.png" alt=""></div><br>
                <span class="form-message"></span><br>
                <span class="form-messages" style="color: red; padding-top:10px; padding-left:20px;">
                    <?php
                    // Kiểm tra xem có thông báo lỗi không đăng nhập không
            ...
            <input id="btn-register" class="btn-register" type="submit" name="dangnhap" value="ĐĂNG NHẬP">

            <a class="link_login_pass" href="#">Quên mật khẩu</a>
            <a class="link_login_pass1" href="#"> Đăng nhập với SMS</a>
            <div class="br_or">
                <div class="br"></div>
            ...
            <div class="btn_mxh">
                <div class="mxh"><img src="/Images/Image/fb.png" alt=""></div>
                <div class="mxh"><img src="/Images/Image/gg.png" alt=""></div>
                <div class="mxh"><img src="/Images/Image/ap.png" alt=""></div>
            </div>
            <div class="create_acc">
                <div class="title_cr">
                    Bạn mới biết đến Shopee?
                </div>
                <a href="./register.html" class="link_create_acc">
                    Đăng ký
                </a>
            </div>
        </form>
    ...
    <footer class="footer">
        <div class="frame-content-footer">
            ...
            <div class="sp-pay">
                ...
                <div class="frame-list-pay">
                    <div class="list-pay">
                        <img src="/Images/Image/vc1.png" alt="" class="img-prd">
                    </div>
                    <div class="list-pay">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            <?php if (isset($_SESSION['error_messages'])) : ?>
                // Lấy thẻ span có class form-message
                var formMessage = document.querySelector(".form-messages");
                // Đặt nội dung của thẻ span bằng thông báo lỗi từ session
                formMessage.innerText = "<?php echo $_SESSION['error_messages']; ?>";
                // Xóa session error_message sau khi sử dụng
