...
<body>
    <div id="main">
        ...
        <div class="header grid wide">
            <div class="row">
                ...
                <!-- Logo Image -->
                <div class="header__logo__img" style="margin-left: -15px;">
                    <a href=""><img src="/Images/dev4.png" alt="" style="height: 95%; width: 150px; margin-top: 3px;"></a>
                </div>
                ...
                <div class="header__search__bar">
                    ...
                    <div class="header__search__bar__input">
                        <input id="searchInput" type="text" placeholder="Bạn cần tìm gì?" style="float: left;" ng-model="searchQuery">
                    </div>

                    <div class="header__search__bar__modal">

                    </div>
                    <a id="searchLink" href="#" style="float: left; text-decoration: none; color: black; width: 40px; margin-top: 10px;margin-left: -30px; " target="_blank"><i class="fa-solid fa-magnifying-glass"></i></a>
                </div>
                <!-- Navbar list -->
                        ...
                        <li class="header__navbar__item">
                            <div class="header__navbar__item__wrapper__last">
                                <a href="" class="header__navbar__item__link">
                                    ...
                                    <div class="header__navbar__item__link__desc__wrapper">
                                        <p id="username-display" style="font-size: 20px;">{{ session('usernames') }}</p>


                                    </div>
                                    <a href="http://127.0.0.1:8000/" style="text-decoration: none; margin-left: 10px; color: #fff;">Đăng Xuất</a>
                                </a>
                            </div>
                        </li>
                    </ul>
                    ...
                    <div class="slidebar">
                        <ul class="slidebar__list">
                            <li class="slidebar__item">
                                <a href="http://127.0.0.1:8000/homepage" class="slidebar__item__link">
                            ...
                            <li class="slidebar__item">
                                <a href="{{ url('/homepage', ['product' => $category]) }}" class="slidebar__item__link">
                                    <div class="slidebar__item__link__text__wrapper">
                                        <div class="slidebar__item__link__text__wrapper__icon__box">
                                            <i class="fa-solid fa-mobile-screen-button"></i>
                                        </div>
                            ...
                            @endforeach
                            <li class="slidebar__item">
                                <a href="http://127.0.0.1:8000/Blogs" target="_blank" class="slidebar__item__link">
                                    <div class="slidebar__item__link__text__wrapper">
                                        <div class="slidebar__item__link__text__wrapper__icon__box">
                                            <i class="fa-solid fa-mobile-screen-button"></i>
                                        </div>
                            ...
                            <li class="slidebar__item">
                                <a href="http://127.0.0.1:8000/cart" target="_blank" class="slidebar__item__link">
                                    <div class="slidebar__item__link__text__wrapper">
                                        <div class="slidebar__item__link__text__wrapper__icon__box">
                                            <i class="fa-solid fa-mobile-screen-button"></i>
                                        </div>
        ...
        <div class="flash__sale grid wide">
            ...
            <div class="row flash__sale__product__list__wrapper">
                <div class="flash__sale__product__lists">
                    @foreach($macbookProducts as $product)
                    <!-- 1st -->
                    <div class="flash__sale__product">
                        <!-- Discount -->
                        <div class="flash__sale__discount" style="color: #fff; font-size:14px; padding-top:5px;padding-left:5px;">
                            Giảm 18%
                            <!-- Bạn có thể thêm logic ở đây để tính toán giảm giá -->
                        </div>
                        <div class="flash__sale__product__img__wrapper_" style="margin-top: 5px;">
                            <a href=""><img src="{{ $product->AnhSanPham }}" alt="" width="210px" height="160px"></a>
                        </div>
                        <div class="flash__sale__product__desc">
                            <div class="title-img-product">
                                {{ $product->TenSanPham }}
                            </div>
                            <div class="d-img-product">
                                đ
                            </div>
                            <div class="price-img-product">
                                {{ number_format($product->GiaGiam, 0) }}
                            </div>
                            <div class="d-img-products">
                                đ
                            </div>
                            <div class="rateprd">
                            ...
                            <div class="total">
                                Số lượng : {{ number_format($product->SoLuong, 0) }}
                            </div>
                            <div class="prd-sold">
                                Đã bán : {{ number_format($product->SoLuongDaBan, 0) }}k
                            </div>
                        </div>
                    </div>
                    @endforeach
    ...
    <div class="featured__phone grid wide" style="height: auto;">
        <!-- Tiêu đề của khối -->
        <div class="row featured__phone__gutter" style="height: auto;">
            <div class="c-3" style="width:1200px;">
                <div class="featured__phone__title" style="height: auto;float:left;margin-right:500px;">
                    <a href="{{ url('/homepage', ['product' => $category]) }}" class="featured__phone__title__text" style="text-decoration:none;">{{ $category }}</a>
                </div>
                <div class="menu-search" ng-controller="ChuyenMucCtrl">
                    <nav class="content-menu-search">
                        <ul class="menu-search-list" style="float: left;">

                            @foreach($categories as $category)
                            <li class="menu-search-item" style="margin-right: 5px; float: left; margin-left: 16px; margin-top: 8px;">
                                <a class="menu-search-link" href="{{ url('/homepage', ['product' => $category]) }}" target="_blank">{{ $category }}</a>
                            </li>
                            @endforeach
        ...
        <!-- Danh sách sản phẩm của loại -->
        <div class="list_prds" style="display:block; height:auto;">
            <div class="featured__phone__product__list">
                <div class="row flash__sale__product__list__wrapper">
                    <div class="flash__sale__product__list">
                        @php
                        $productCount = count($products);
                        $numRows = ceil($productCount / 5);
                        $startIndex = 0;
                        @endphp

                        @for ($i = 0; $i < $numRows; $i++) <div class="list-prd" style="display:inline-block;margin-right:20px; width:1200px;height:400px;">
                            @for ($j = $startIndex; $j < min($startIndex + 5, $productCount); $j++) <div class="prd" style="float: left; width:220px; height:390px; margin-right:20px;">
                                <div class="flash__sale__product">
                                    <div class="flash__sale__discount">
                                        <p>Giảm 18%</p>
                                    </div>
                                    <div class="flash__sale__product__img__wrapper" style="margin-left: 15px;">
                                        <a href=""><img src="{{ $products[$j]->AnhSanPham }}" alt="" height="210px" width="200px"></a>
                                    </div>
                                    <div class="flash__sale__product__desc">
                                        <div class="title-img-product" style="font-size: 12px;margin-top:50px;">
                                            {{ $products[$j]->TenSanPham }}
                                        </div>
                                        <div class="d-img-product" style="margin-top: 15px; margin-left: -2px;">đ</div>
                                        <div class="price-img-product" style="margin-top: 13px; margin-right: 25px ; margin-left: -0px">{{ number_format($products[$j]->GiaGiam, 0) }}</div>
                                        <div class="d-img-products" style="margin-top: 15px; margin-left:10px">đ</div>
                                        <div class="rateprd" style="margin-top: 13px;">{{ number_format($products[$j]->Gia, 0) }}</div>
                                        <div class="total" style="display: inline-block; font-size: 13px;width: 111px;margin-top: 30px;margin-left: -1px;color: #666666">Số lượng : {{ number_format($products[$j]->SoLuong, 0) }}</div>
                                        <div class="prd-sold" style="margin-left: 8px">Đã bán : {{ number_format($products[$j]->SoLuongDaBan, 0) }}k</div>
                                    </div>
                                </div>
                    </div>
                    @endfor
    ...
    <div class="featured__phone grid wide">
        ...
        <div class="row">
            ...
            <div class="brand__wrapper" style="width: 285px">
                <a href="{{ $advertisement->LinkQuangCao }}" target="_blank">
                    <img src="{{ $advertisement->AnhQuangCao }}" alt="" class="brand__img">
                </a>
            </div>
            @endforeach
    ...
    <script>
        document.getElementById('searchLink').addEventListener('click', function(event) {
            ...
            // Encode the searchQuery for URL
            var encodedSearchQuery = encodeURIComponent(searchQuery);

            // Construct the URL with the search query
            var url = "http://127.0.0.1:8000/searchPrd/" + encodedSearchQuery;
