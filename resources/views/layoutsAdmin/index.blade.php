        ...
        ***********************************-->
		<div class="nav-header">
            <a href="index.html" class="brand-logo">
				<img src="/Images/avt1.jpg" alt="" width="55" height="55" style="border-radius: 50%;">
				<div class="brand-title">
					<h2 class="">ADMIN</h2>
					<span class="brand-sub-title">@Truongdev2k3</span>
				</div>
            </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown  header-profile">
								<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
									<img src="{{session('anhdaidien')}}" width="56" alt="">
								</a>
								<div class="dropdown-menu dropdown-menu-end">
									...
									<a href="http://127.0.0.1:8000/" class="dropdown-item ai-icon">
            ...
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="http://127.0.0.1:8000/product" target="_blank">Product</a></li>
							<li><a href="http://127.0.0.1:8000/customers" target="_blank">Bill</a></li>
                           
                            <li><a href="http://127.0.0.1:8000/customers" target="_blank">Detail Bill</a></li>
							<li><a href="http://127.0.0.1:8000/customers" target="_blank">Customer</a>
				...
				<div class="side-bar-profile">
					<div class="d-flex align-items-center justify-content-between mb-3">
						<div class="side-bar-profile-img">
							<img src="{{session('anhdaidien')}}" alt="">
						</div>
						<div class="profile-info1">
							<h4 class="fs-18 font-w500">{{ session('usernames') }}</h4>
